...
class Model extends Component {
  ...
  moveLights() {
    ...
    this.light1.position.x = Math.sin(time * 0.7) * 100;
    this.light1.position.y = Math.cos(time * 0.5) * 200;
    this.light1.position.z = Math.cos(time * 0.3) * 100;

    this.light2.position.x = Math.cos(time * 0.3) * 100;
    this.light2.position.y = Math.sin(time * 0.5) * 200;
    this.light2.position.z = Math.sin(time * 0.7) * 100;

    this.light3.position.x = Math.sin(time * 0.7) * 100;
    this.light3.position.y = Math.cos(time * 0.3) * 200;
    this.light3.position.z = Math.sin(time * 0.5) * 100;

    this.light4.position.x = Math.cos(time * 0.3) * 100;
    this.light4.position.y = Math.cos(time * 0.7) * 200;
    this.light4.position.z = Math.sin(time * 0.5) * 100;

    this.light5.position.x = Math.cos(time * 0.3) * 100;
    this.light5.position.y = Math.sin(time * 0.7) * 200;
    this.light5.position.z = Math.cos(time * 0.5) * 100;
  }
